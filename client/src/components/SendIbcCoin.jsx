...
import { StargateClient, SigningStargateClient, assertIsBroadcastTxSuccess } from '@cosmjs/stargate';

function SendIbcCoin() {
    ...
    const handleSubmit = async event => {
        ...
        try {
            ...
            const Alamat = accounts[0].address
            const allBalances = await client.getAllBalances(Alamat);
            ...
            client.sendIbcTokens(accounts[0].address,recipient, amountFinal, 'transfer', 'channel-0', undefined, 1704041999 , fee, memo)  ;
